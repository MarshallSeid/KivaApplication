...
for i in range(1,num_pages+1):
	...
	for loan in parsed["loans"]:
		...
		coord = []
		coord.append(loan["use"] + '\n Click <a href="https://www.kiva.org/lend/"' + str(loan["id"]) + '>here</a> to go to Kiva')
		pair = loan["location"]["geo"]["pairs"].split(" ")
		coord.append(float(pair[0]))
		coord.append(float(pair[1]))
		coords.append(coord)
